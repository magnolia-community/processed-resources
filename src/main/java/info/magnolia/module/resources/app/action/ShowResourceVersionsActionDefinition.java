...
/**
 * Definition for {@link ShowResourceVersionsAction}. Adds a mapping functionality to decide which subApp to open based on
 * {@link info.magnolia.jcr.util.NodeTypes.Renderable#TEMPLATE}.
 *
...
public class ShowResourceVersionsActionDefinition extends ShowVersionsActionDefinition {
    private Map<String, String> subAppMapping = new HashMap<String, String>();
    ...
    public Map<String, String> getSubAppMapping() {
        return subAppMapping;
    }

    public void setSubAppMapping(Map<String, String> subAppMapping) {
        this.subAppMapping = subAppMapping;
    }
}
